movetoplay.controller('ctrl', ['$scope', '$interval', '$translate', '$cordovaBeacon', 'qrcodeFct', 'gameFct', 'dataFct', 'audioFct', function($scope, $interval, $translate, $cordovaBeacon, qrcodeFct, gameFct, dataFct, audioFct) {
